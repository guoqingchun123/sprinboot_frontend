...
export function removeShow(id) {
  return http.get('/api/removeShow/'+id)
}
...
export function fetchPersonUnlock(query) {
  return http.get('/api/ess/unlock', {
    params: query
  })
}
//个人令牌挂失
export function lostPersonToken(query) {
  return http.get('/api/ess/lost', {
    params: query
  })
}
...
export function deadPersonToken(query) {
  return http.get('/api/ess/disable', {
    params: query
  })
}
...
export function startPersonToken(query) {
  return http.get('/api/ess/start', {
    params: query
  })
}
//个人令牌解挂
export function unlostPersonToken(query) {
  return http.get('/api/ess/unlost', {
    params: query
  })
}
//个人令牌回收
export function backPersonToken(query) {
  return http.get('/api/ess/back', {
    params: query
  })
}
//个人令牌新增
export function allotPersonToken(query) {
  return http.get('/api/ess/allot', {
    params: query
  })
}
...
// 查询流程信息
export function fetchOtherFlow(query) {
  return http.get('/api/flow', {
    params: query
  });
}
export function removeFlows(data) {
  return http.post('/api/flowRemove', data);
}
export function createFlow(data) {
  return http.post('/api/flow', data)
}
export function modifyFlow(data) {
  return http.put('/api/flow', data)
}
export function fetchOtherFlowTree(data) {
  return http.post('/api/flowTree', data)
}
