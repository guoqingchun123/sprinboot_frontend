...
export function fetchOnlineUsers() {
  return http.get('/api/authority/online')
}

export function notifyAllUsers(data) {
  return http.post('/api/message/notify/every', data)
}
export function notifyUsers(ids, data) {
  return http.post('/api/message/notify/' + ids, data)
}
export function offlineUsers(ids) {
  return http.put('/api/authority/offline/' + ids)
}