...
export function fetchSaleInfo(query) {
  return http.get('/api/project/sales', {
    params: query
  })
}
//新增销售项目信息
export function addSaleInfo(data) {
  return http.post('/api/project/sales', data)
}

//修改销售项目信息
export function editSaleInfo(data) {
  return http.put('/api/project/sales', data)
}
//立项失败-删除销售项目信息
export function deleteSaleInfo(id) {
  return http.delete('/api/project/sales/' + id)
}
// 立项成功
export function saleSuccess(id) {
  return http.put('/api/project/sales/' + id + '/success')
}
//获取新增/修改销售项目初始数据
export function fetchSaleData() {
  return http.get('/api/project/sales/params')
}
//保存审批意见
export function saveApprovalSale(data) {
  return http.put('/api/project/sales/approval',data)
}
//////////////// 售前
export function fetchPresaleEmpList() {
  return http.get('/api/project/presales/employees')
}
// 售前记录
export function fetchPresaleSupportInfos(data) {
  return http.get('/api/project/presales',{
    params:data
  })
}
//导入售前项目信息
export function importSale(file,data) {
  return http.upload('/api/project/sales/imports',file,data)
}
//模板下载
...
export function fetchBasicProjInfo(query) {
  return http.get('/api/project/develops', {
    params: query
  })
}
...
export function insertProjInfo(data) {
  return http.post('/api/project/develops', data)
}

//修改项目信息
export function updateProjInfo(data) {
  return http.put('/api/project/develops', data)
}

//删除项目信息
export function deleteProjInfo(id) {
  return http.delete('/api/project/develops/' + id)
}
