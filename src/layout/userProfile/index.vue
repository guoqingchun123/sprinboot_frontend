...
export default {
    ...
    settings: {
      handler: function(settings) {
        this.$refs.form.validate(valid => {
          ...
          this.$nextTick(() => {
            this.$store.dispatch('settings/changeSettings', settings)
          })
        })
      },
      deep: true
  ...
  computed: {
    /*fixedHeader: {
      get() {
        return this.$store.state.settings.layout.fixedHeader
      },
      // 目前会出现js错误
      set(val) {
    ...
    tagsView: {
      get() {
        return this.$store.state.settings.layout.tagsView
      },
      set(val) {
        this.$store.dispatch('settings/changeSetting', {
          key: 'tagsView',
  ...
  methods: {
    ...
    /*changeFixedHeader() {
      this.$nextTick(() => {
        this.$store.dispatch('settings/changeSetting', {
          key: 'fixedHeader',
          value: this.settings.layout.fixedHeader
        })
      })
    }*/
  }
