<template>
  <div id="appContainer">
    <div id="mapContainer" class="region-map"></div>
...
<script>
  ...
  //设置地图全屏显示
  function getSize() {
    const width = $('.app-main-container').width() - 30;
    const height = $('.app-main-container').height() - 20;
    $('.region-map').width(width);
    $('.region-map').height(height);
  }
  //监听窗口大小变化
