<template>
  <div class="app-container">
    <bv-table ref="table" title="季度自评" :pagination="true" :filter.sync="filter" :fetch-api="showQuqEvaluate" @on-mounted="(table) => tableInstance = table">
      <div slot="operates">
...
<script>
  import { showQuqEvaluate} from '@/api/employee/otherManage'
  export default {
